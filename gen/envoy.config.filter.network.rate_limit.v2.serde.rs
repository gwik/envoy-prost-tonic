...
impl serde::Serialize for RateLimit {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("envoy.config.filter.network.rate_limit.v2.RateLimit", len)?;
        if !self.stat_prefix.is_empty() {
...
impl<'de> serde::Deserialize<'de> for RateLimit {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.config.filter.network.rate_limit.v2.RateLimit")
            }
        ...
        deserializer.deserialize_struct("envoy.config.filter.network.rate_limit.v2.RateLimit", FIELDS, GeneratedVisitor)
    }
}
