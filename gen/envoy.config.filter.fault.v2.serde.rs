...
impl serde::Serialize for FaultDelay {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("envoy.config.filter.fault.v2.FaultDelay", len)?;
        if self.r#type != 0 {
            let v = fault_delay::FaultDelayType::from_i32(self.r#type)
...
impl<'de> serde::Deserialize<'de> for FaultDelay {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.config.filter.fault.v2.FaultDelay")
            }
                ...
                while let Some(k) = map.next_key()? {
                    match k {
                        GeneratedField::Type => {
                            ...
                            r#type__ = Some(map.next_value::<fault_delay::FaultDelayType>()? as i32);
                        }
...
;
        ...
        deserializer.deserialize_struct("envoy.config.filter.fault.v2.FaultDelay", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for fault_delay::HeaderDelay {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("envoy.config.filter.fault.v2.FaultDelay.HeaderDelay", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for fault_delay::HeaderDelay {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.config.filter.fault.v2.FaultDelay.HeaderDelay")
            }
        ...
        deserializer.deserialize_struct("envoy.config.filter.fault.v2.FaultDelay.HeaderDelay", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for FaultRateLimit {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("envoy.config.filter.fault.v2.FaultRateLimit", len)?;
        if let Some(v) = self.percentage.as_ref() {
            struct_ser.serialize_field("percentage", v)?;
        }
...
impl<'de> serde::Deserialize<'de> for FaultRateLimit {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.config.filter.fault.v2.FaultRateLimit")
            }
...
;
        ...
        deserializer.deserialize_struct("envoy.config.filter.fault.v2.FaultRateLimit", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for fault_rate_limit::FixedLimit {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("envoy.config.filter.fault.v2.FaultRateLimit.FixedLimit", len)?;
        if self.limit_kbps != 0 {
...
impl<'de> serde::Deserialize<'de> for fault_rate_limit::FixedLimit {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.config.filter.fault.v2.FaultRateLimit.FixedLimit")
            }
        ...
        deserializer.deserialize_struct("envoy.config.filter.fault.v2.FaultRateLimit.FixedLimit", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for fault_rate_limit::HeaderLimit {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("envoy.config.filter.fault.v2.FaultRateLimit.HeaderLimit", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for fault_rate_limit::HeaderLimit {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.config.filter.fault.v2.FaultRateLimit.HeaderLimit")
            }
        ...
        deserializer.deserialize_struct("envoy.config.filter.fault.v2.FaultRateLimit.HeaderLimit", FIELDS, GeneratedVisitor)
    }
}
