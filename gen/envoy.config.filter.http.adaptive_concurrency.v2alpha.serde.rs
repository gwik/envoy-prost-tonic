...
impl serde::Serialize for AdaptiveConcurrency {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("envoy.config.filter.http.adaptive_concurrency.v2alpha.AdaptiveConcurrency", len)?;
...
impl<'de> serde::Deserialize<'de> for AdaptiveConcurrency {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.config.filter.http.adaptive_concurrency.v2alpha.AdaptiveConcurrency")
            }
...
;
        ...
        deserializer.deserialize_struct("envoy.config.filter.http.adaptive_concurrency.v2alpha.AdaptiveConcurrency", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GradientControllerConfig {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("envoy.config.filter.http.adaptive_concurrency.v2alpha.GradientControllerConfig", len)?;
...
impl<'de> serde::Deserialize<'de> for GradientControllerConfig {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.config.filter.http.adaptive_concurrency.v2alpha.GradientControllerConfig")
            }
        ...
        deserializer.deserialize_struct("envoy.config.filter.http.adaptive_concurrency.v2alpha.GradientControllerConfig", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for gradient_controller_config::ConcurrencyLimitCalculationParams {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("envoy.config.filter.http.adaptive_concurrency.v2alpha.GradientControllerConfig.ConcurrencyLimitCalculationParams", len)?;
...
impl<'de> serde::Deserialize<'de> for gradient_controller_config::ConcurrencyLimitCalculationParams {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.config.filter.http.adaptive_concurrency.v2alpha.GradientControllerConfig.ConcurrencyLimitCalculationParams")
            }
        ...
        deserializer.deserialize_struct("envoy.config.filter.http.adaptive_concurrency.v2alpha.GradientControllerConfig.ConcurrencyLimitCalculationParams", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for gradient_controller_config::MinimumRttCalculationParams {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("envoy.config.filter.http.adaptive_concurrency.v2alpha.GradientControllerConfig.MinimumRTTCalculationParams", len)?;
...
impl<'de> serde::Deserialize<'de> for gradient_controller_config::MinimumRttCalculationParams {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.config.filter.http.adaptive_concurrency.v2alpha.GradientControllerConfig.MinimumRTTCalculationParams")
            }
        ...
        deserializer.deserialize_struct("envoy.config.filter.http.adaptive_concurrency.v2alpha.GradientControllerConfig.MinimumRTTCalculationParams", FIELDS, GeneratedVisitor)
    }
}
