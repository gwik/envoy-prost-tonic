...
impl serde::Serialize for ClientSslAuth {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("envoy.config.filter.network.client_ssl_auth.v2.ClientSSLAuth", len)?;
        if !self.auth_api_cluster.is_empty() {
...
impl<'de> serde::Deserialize<'de> for ClientSslAuth {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.config.filter.network.client_ssl_auth.v2.ClientSSLAuth")
            }
        ...
        deserializer.deserialize_struct("envoy.config.filter.network.client_ssl_auth.v2.ClientSSLAuth", FIELDS, GeneratedVisitor)
    }
}
