...
impl serde::Serialize for Rbac {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("envoy.config.filter.network.rbac.v2.RBAC", len)?;
...
impl<'de> serde::Deserialize<'de> for Rbac {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.config.filter.network.rbac.v2.RBAC")
            }
        ...
        deserializer.deserialize_struct("envoy.config.filter.network.rbac.v2.RBAC", FIELDS, GeneratedVisitor)
    }
}
