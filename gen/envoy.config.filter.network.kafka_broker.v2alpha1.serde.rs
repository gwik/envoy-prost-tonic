...
impl serde::Serialize for KafkaBroker {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("envoy.config.filter.network.kafka_broker.v2alpha1.KafkaBroker", len)?;
        if !self.stat_prefix.is_empty() {
...
impl<'de> serde::Deserialize<'de> for KafkaBroker {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.config.filter.network.kafka_broker.v2alpha1.KafkaBroker")
            }
        ...
        deserializer.deserialize_struct("envoy.config.filter.network.kafka_broker.v2alpha1.KafkaBroker", FIELDS, GeneratedVisitor)
    }
}
