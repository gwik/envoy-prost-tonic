...
impl serde::Serialize for InjectedResourceConfig {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("envoy.config.resource_monitor.injected_resource.v2alpha.InjectedResourceConfig", len)?;
        if !self.filename.is_empty() {
...
impl<'de> serde::Deserialize<'de> for InjectedResourceConfig {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.config.resource_monitor.injected_resource.v2alpha.InjectedResourceConfig")
            }
        ...
        deserializer.deserialize_struct("envoy.config.resource_monitor.injected_resource.v2alpha.InjectedResourceConfig", FIELDS, GeneratedVisitor)
    }
}
