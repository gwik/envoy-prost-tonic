...
impl serde::Serialize for FaultAbort {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("envoy.config.filter.http.fault.v2.FaultAbort", len)?;
...
impl<'de> serde::Deserialize<'de> for FaultAbort {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.config.filter.http.fault.v2.FaultAbort")
            }
...
;
        ...
        deserializer.deserialize_struct("envoy.config.filter.http.fault.v2.FaultAbort", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for fault_abort::HeaderAbort {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("envoy.config.filter.http.fault.v2.FaultAbort.HeaderAbort", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for fault_abort::HeaderAbort {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.config.filter.http.fault.v2.FaultAbort.HeaderAbort")
            }
        ...
        deserializer.deserialize_struct("envoy.config.filter.http.fault.v2.FaultAbort.HeaderAbort", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for HttpFault {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("envoy.config.filter.http.fault.v2.HTTPFault", len)?;
...
impl<'de> serde::Deserialize<'de> for HttpFault {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.config.filter.http.fault.v2.HTTPFault")
            }
        ...
        deserializer.deserialize_struct("envoy.config.filter.http.fault.v2.HTTPFault", FIELDS, GeneratedVisitor)
    }
}
