...
impl serde::Serialize for ClusterConfig {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("envoy.config.cluster.aggregate.v2alpha.ClusterConfig", len)?;
        if !self.clusters.is_empty() {
...
impl<'de> serde::Deserialize<'de> for ClusterConfig {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.config.cluster.aggregate.v2alpha.ClusterConfig")
            }
        ...
        deserializer.deserialize_struct("envoy.config.cluster.aggregate.v2alpha.ClusterConfig", FIELDS, GeneratedVisitor)
    }
}
