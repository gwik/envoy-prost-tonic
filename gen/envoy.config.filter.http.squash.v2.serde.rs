...
impl serde::Serialize for Squash {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("envoy.config.filter.http.squash.v2.Squash", len)?;
        if !self.cluster.is_empty() {
...
impl<'de> serde::Deserialize<'de> for Squash {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.config.filter.http.squash.v2.Squash")
            }
        ...
        deserializer.deserialize_struct("envoy.config.filter.http.squash.v2.Squash", FIELDS, GeneratedVisitor)
    }
}
