...
impl serde::Serialize for OmitHostMetadataConfig {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("envoy.config.retry.omit_host_metadata.v2.OmitHostMetadataConfig", len)?;
...
impl<'de> serde::Deserialize<'de> for OmitHostMetadataConfig {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.config.retry.omit_host_metadata.v2.OmitHostMetadataConfig")
            }
        ...
        deserializer.deserialize_struct("envoy.config.retry.omit_host_metadata.v2.OmitHostMetadataConfig", FIELDS, GeneratedVisitor)
    }
}
