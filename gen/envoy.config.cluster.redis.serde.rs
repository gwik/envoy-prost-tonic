...
impl serde::Serialize for RedisClusterConfig {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("envoy.config.cluster.redis.RedisClusterConfig", len)?;
...
impl<'de> serde::Deserialize<'de> for RedisClusterConfig {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.config.cluster.redis.RedisClusterConfig")
            }
        ...
        deserializer.deserialize_struct("envoy.config.cluster.redis.RedisClusterConfig", FIELDS, GeneratedVisitor)
    }
}
