...
impl serde::Serialize for DegradedHealthyHost {
        ...
        S: serde::Serializer,
    {
        ...
        let len = 0;
        let struct_ser = serializer.serialize_struct("envoy.data.core.v2alpha.DegradedHealthyHost", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for DegradedHealthyHost {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.data.core.v2alpha.DegradedHealthyHost")
            }
        ...
        deserializer.deserialize_struct("envoy.data.core.v2alpha.DegradedHealthyHost", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for HealthCheckAddHealthy {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("envoy.data.core.v2alpha.HealthCheckAddHealthy", len)?;
        if self.first_check {
...
impl<'de> serde::Deserialize<'de> for HealthCheckAddHealthy {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.data.core.v2alpha.HealthCheckAddHealthy")
            }
        ...
        deserializer.deserialize_struct("envoy.data.core.v2alpha.HealthCheckAddHealthy", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for HealthCheckEjectUnhealthy {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("envoy.data.core.v2alpha.HealthCheckEjectUnhealthy", len)?;
        if self.failure_type != 0 {
...
impl<'de> serde::Deserialize<'de> for HealthCheckEjectUnhealthy {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.data.core.v2alpha.HealthCheckEjectUnhealthy")
            }
        ...
        deserializer.deserialize_struct("envoy.data.core.v2alpha.HealthCheckEjectUnhealthy", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for HealthCheckEvent {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("envoy.data.core.v2alpha.HealthCheckEvent", len)?;
        if self.health_checker_type != 0 {
...
impl<'de> serde::Deserialize<'de> for HealthCheckEvent {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.data.core.v2alpha.HealthCheckEvent")
            }
...
;
        ...
        deserializer.deserialize_struct("envoy.data.core.v2alpha.HealthCheckEvent", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for HealthCheckFailure {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("envoy.data.core.v2alpha.HealthCheckFailure", len)?;
        if self.failure_type != 0 {
            let v = HealthCheckFailureType::from_i32(self.failure_type)
                .ok_or_else(|| serde::ser::Error::custom(format!("Invalid variant {}", self.failure_type)))?;
            struct_ser.serialize_field("failureType", &v)?;
...
impl<'de> serde::Deserialize<'de> for HealthCheckFailure {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.data.core.v2alpha.HealthCheckFailure")
            }
        ...
        deserializer.deserialize_struct("envoy.data.core.v2alpha.HealthCheckFailure", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for NoLongerDegradedHost {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("envoy.data.core.v2alpha.NoLongerDegradedHost", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for NoLongerDegradedHost {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.data.core.v2alpha.NoLongerDegradedHost")
            }
