...
impl serde::Serialize for Body {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("envoy.data.tap.v2alpha.Body", len)?;
        if self.truncated {
...
impl<'de> serde::Deserialize<'de> for Body {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.data.tap.v2alpha.Body")
            }
        ...
        deserializer.deserialize_struct("envoy.data.tap.v2alpha.Body", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Connection {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("envoy.data.tap.v2alpha.Connection", len)?;
...
impl<'de> serde::Deserialize<'de> for Connection {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.data.tap.v2alpha.Connection")
            }
        ...
        deserializer.deserialize_struct("envoy.data.tap.v2alpha.Connection", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for HttpBufferedTrace {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("envoy.data.tap.v2alpha.HttpBufferedTrace", len)?;
...
impl<'de> serde::Deserialize<'de> for HttpBufferedTrace {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.data.tap.v2alpha.HttpBufferedTrace")
            }
        ...
        deserializer.deserialize_struct("envoy.data.tap.v2alpha.HttpBufferedTrace", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for http_buffered_trace::Message {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("envoy.data.tap.v2alpha.HttpBufferedTrace.Message", len)?;
        if !self.headers.is_empty() {
...
impl<'de> serde::Deserialize<'de> for http_buffered_trace::Message {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.data.tap.v2alpha.HttpBufferedTrace.Message")
            }
        ...
        deserializer.deserialize_struct("envoy.data.tap.v2alpha.HttpBufferedTrace.Message", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for HttpStreamedTraceSegment {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("envoy.data.tap.v2alpha.HttpStreamedTraceSegment", len)?;
        if self.trace_id != 0 {
...
impl<'de> serde::Deserialize<'de> for HttpStreamedTraceSegment {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.data.tap.v2alpha.HttpStreamedTraceSegment")
            }
...
;
        ...
        deserializer.deserialize_struct("envoy.data.tap.v2alpha.HttpStreamedTraceSegment", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for SocketBufferedTrace {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("envoy.data.tap.v2alpha.SocketBufferedTrace", len)?;
        if self.trace_id != 0 {
            struct_ser.serialize_field("traceId", ToString::to_string(&self.trace_id).as_str())?;
        }
...
impl<'de> serde::Deserialize<'de> for SocketBufferedTrace {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.data.tap.v2alpha.SocketBufferedTrace")
            }
        ...
        deserializer.deserialize_struct("envoy.data.tap.v2alpha.SocketBufferedTrace", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for SocketEvent {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("envoy.data.tap.v2alpha.SocketEvent", len)?;
...
impl<'de> serde::Deserialize<'de> for SocketEvent {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.data.tap.v2alpha.SocketEvent")
            }
...
;
        ...
        deserializer.deserialize_struct("envoy.data.tap.v2alpha.SocketEvent", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for socket_event::Closed {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("envoy.data.tap.v2alpha.SocketEvent.Closed", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for socket_event::Closed {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.data.tap.v2alpha.SocketEvent.Closed")
            }
        ...
        deserializer.deserialize_struct("envoy.data.tap.v2alpha.SocketEvent.Closed", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for socket_event::Read {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("envoy.data.tap.v2alpha.SocketEvent.Read", len)?;
...
impl<'de> serde::Deserialize<'de> for socket_event::Read {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.data.tap.v2alpha.SocketEvent.Read")
            }
        ...
        deserializer.deserialize_struct("envoy.data.tap.v2alpha.SocketEvent.Read", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for socket_event::Write {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("envoy.data.tap.v2alpha.SocketEvent.Write", len)?;
        if let Some(v) = self.data.as_ref() {
            struct_ser.serialize_field("data", v)?;
        }
        if self.end_stream {
...
impl<'de> serde::Deserialize<'de> for socket_event::Write {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.data.tap.v2alpha.SocketEvent.Write")
            }
        ...
        deserializer.deserialize_struct("envoy.data.tap.v2alpha.SocketEvent.Write", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for SocketStreamedTraceSegment {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("envoy.data.tap.v2alpha.SocketStreamedTraceSegment", len)?;
        if self.trace_id != 0 {
            struct_ser.serialize_field("traceId", ToString::to_string(&self.trace_id).as_str())?;
        }
        if let Some(v) = self.message_piece.as_ref() {
...
impl<'de> serde::Deserialize<'de> for SocketStreamedTraceSegment {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.data.tap.v2alpha.SocketStreamedTraceSegment")
            }
...
;
        ...
        deserializer.deserialize_struct("envoy.data.tap.v2alpha.SocketStreamedTraceSegment", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for TraceWrapper {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("envoy.data.tap.v2alpha.TraceWrapper", len)?;
...
impl<'de> serde::Deserialize<'de> for TraceWrapper {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.data.tap.v2alpha.TraceWrapper")
            }
...
;
        ...
        deserializer.deserialize_struct("envoy.data.tap.v2alpha.TraceWrapper", FIELDS, GeneratedVisitor)
    }
}
