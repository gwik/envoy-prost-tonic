...
impl serde::Serialize for ZooKeeperProxy {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("envoy.config.filter.network.zookeeper_proxy.v1alpha1.ZooKeeperProxy", len)?;
        if !self.stat_prefix.is_empty() {
...
impl<'de> serde::Deserialize<'de> for ZooKeeperProxy {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.config.filter.network.zookeeper_proxy.v1alpha1.ZooKeeperProxy")
            }
        ...
        deserializer.deserialize_struct("envoy.config.filter.network.zookeeper_proxy.v1alpha1.ZooKeeperProxy", FIELDS, GeneratedVisitor)
    }
}
