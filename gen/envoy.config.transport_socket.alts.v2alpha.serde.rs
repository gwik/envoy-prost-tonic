...
impl serde::Serialize for Alts {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("envoy.config.transport_socket.alts.v2alpha.Alts", len)?;
        if !self.handshaker_service.is_empty() {
...
impl<'de> serde::Deserialize<'de> for Alts {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.config.transport_socket.alts.v2alpha.Alts")
            }
        ...
        deserializer.deserialize_struct("envoy.config.transport_socket.alts.v2alpha.Alts", FIELDS, GeneratedVisitor)
    }
}
