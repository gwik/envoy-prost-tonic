...
impl<'de> serde::Deserialize<'de> for FilterStateMatcher {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map: V) -> std::result::Result<FilterStateMatcher, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut key__ = None;
                ...
                while let Some(k) = map.next_key()? {
                    match k {
                        ...
                        GeneratedField::StringMatch => {
                            ...
                            matcher__ = map.next_value::<::std::option::Option<_>>()?.map(filter_state_matcher::Matcher::StringMatch)
;
                        }
                    }
                }
...
impl<'de> serde::Deserialize<'de> for HttpRequestHeaderMatchInput {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map: V) -> std::result::Result<HttpRequestHeaderMatchInput, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
...
impl serde::Serialize for HttpRequestQueryParamMatchInput {
        ...
        S: serde::Serializer,
    {
        ...
        if !self.query_param.is_empty() {
            struct_ser.serialize_field("queryParam", &self.query_param)?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for HttpRequestQueryParamMatchInput {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map: V) -> std::result::Result<HttpRequestQueryParamMatchInput, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                while let Some(k) = map.next_key()? {
                    match k {
                        GeneratedField::QueryParam => {
                            ...
                            query_param__ = Some(map.next_value()?);
                        }
                    }
                }
...
impl<'de> serde::Deserialize<'de> for HttpRequestTrailerMatchInput {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map: V) -> std::result::Result<HttpRequestTrailerMatchInput, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut header_name__ = None;
...
impl<'de> serde::Deserialize<'de> for HttpResponseHeaderMatchInput {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map: V) -> std::result::Result<HttpResponseHeaderMatchInput, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut header_name__ = None;
...
impl<'de> serde::Deserialize<'de> for HttpResponseStatusCodeClassMatchInput {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map: V) -> std::result::Result<HttpResponseStatusCodeClassMatchInput, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
...
impl<'de> serde::Deserialize<'de> for HttpResponseStatusCodeMatchInput {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map: V) -> std::result::Result<HttpResponseStatusCodeMatchInput, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                while map.next_key::<GeneratedField>()?.is_some() {
...
impl<'de> serde::Deserialize<'de> for HttpResponseTrailerMatchInput {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map: V) -> std::result::Result<HttpResponseTrailerMatchInput, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut header_name__ = None;
