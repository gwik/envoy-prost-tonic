// @generated
impl serde::Serialize for QatPrivateKeyMethodConfig {
    #[allow(deprecated)]
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("envoy.extensions.private_key_providers.qat.v3alpha.QatPrivateKeyMethodConfig", len)?;
...
impl<'de> serde::Deserialize<'de> for QatPrivateKeyMethodConfig {
    #[allow(deprecated)]
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = QatPrivateKeyMethodConfig;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.extensions.private_key_providers.qat.v3alpha.QatPrivateKeyMethodConfig")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<QatPrivateKeyMethodConfig, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(QatPrivateKeyMethodConfig {
                    private_key: private_key__,
                    poll_delay: poll_delay__,
                })
            }
        }
        deserializer.deserialize_struct("envoy.extensions.private_key_providers.qat.v3alpha.QatPrivateKeyMethodConfig", FIELDS, GeneratedVisitor)
    }
}
