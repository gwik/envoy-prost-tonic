...
impl serde::Serialize for FilterConfig {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("envoy.config.filter.http.grpc_stats.v2alpha.FilterConfig", len)?;
        if self.emit_filter_state {
...
impl<'de> serde::Deserialize<'de> for FilterConfig {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.config.filter.http.grpc_stats.v2alpha.FilterConfig")
            }
...
;
        ...
        deserializer.deserialize_struct("envoy.config.filter.http.grpc_stats.v2alpha.FilterConfig", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for FilterObject {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("envoy.config.filter.http.grpc_stats.v2alpha.FilterObject", len)?;
        if self.request_message_count != 0 {
...
impl<'de> serde::Deserialize<'de> for FilterObject {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.config.filter.http.grpc_stats.v2alpha.FilterObject")
            }
        ...
        deserializer.deserialize_struct("envoy.config.filter.http.grpc_stats.v2alpha.FilterObject", FIELDS, GeneratedVisitor)
    }
}
