...
impl serde::Serialize for OriginalSrc {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("envoy.config.filter.listener.original_src.v2alpha1.OriginalSrc", len)?;
        if self.bind_port {
...
impl<'de> serde::Deserialize<'de> for OriginalSrc {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.config.filter.listener.original_src.v2alpha1.OriginalSrc")
            }
        ...
        deserializer.deserialize_struct("envoy.config.filter.listener.original_src.v2alpha1.OriginalSrc", FIELDS, GeneratedVisitor)
    }
}
