...
impl serde::Serialize for FilterConfig {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("envoy.config.filter.http.grpc_http1_reverse_bridge.v2alpha1.FilterConfig", len)?;
        if !self.content_type.is_empty() {
...
impl<'de> serde::Deserialize<'de> for FilterConfig {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.config.filter.http.grpc_http1_reverse_bridge.v2alpha1.FilterConfig")
            }
        ...
        deserializer.deserialize_struct("envoy.config.filter.http.grpc_http1_reverse_bridge.v2alpha1.FilterConfig", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for FilterConfigPerRoute {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("envoy.config.filter.http.grpc_http1_reverse_bridge.v2alpha1.FilterConfigPerRoute", len)?;
        if self.disabled {
...
impl<'de> serde::Deserialize<'de> for FilterConfigPerRoute {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.config.filter.http.grpc_http1_reverse_bridge.v2alpha1.FilterConfigPerRoute")
            }
        ...
        deserializer.deserialize_struct("envoy.config.filter.http.grpc_http1_reverse_bridge.v2alpha1.FilterConfigPerRoute", FIELDS, GeneratedVisitor)
    }
}
