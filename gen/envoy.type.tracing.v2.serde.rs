...
impl serde::Serialize for CustomTag {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("envoy.r#type.tracing.v2.CustomTag", len)?;
        if !self.tag.is_empty() {
        ...
        if let Some(v) = self.r#type.as_ref() {
            match v {
                ...
                custom_tag::Type::RequestHeader(v) => {
                    struct_ser.serialize_field("requestHeader", v)?;
                }
...
impl<'de> serde::Deserialize<'de> for CustomTag {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.r#type.tracing.v2.CustomTag")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<CustomTag, V::Error>
                where
                ...
                while let Some(k) = map.next_key()? {
                    match k {
                        ...
                        GeneratedField::Literal => {
                            ...
                            r#type__ = map.next_value::<::std::option::Option<_>>()?.map(custom_tag::Type::Literal)
;
                        }
                        GeneratedField::Environment => {
                            ...
                            r#type__ = map.next_value::<::std::option::Option<_>>()?.map(custom_tag::Type::Environment)
;
                        }
                        GeneratedField::RequestHeader => {
                            ...
                            r#type__ = map.next_value::<::std::option::Option<_>>()?.map(custom_tag::Type::RequestHeader)
;
                        }
                        GeneratedField::Metadata => {
                            ...
                            r#type__ = map.next_value::<::std::option::Option<_>>()?.map(custom_tag::Type::Metadata)
;
                        }
                    }
                }
        ...
        deserializer.deserialize_struct("envoy.r#type.tracing.v2.CustomTag", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for custom_tag::Environment {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("envoy.r#type.tracing.v2.CustomTag.Environment", len)?;
        if !self.name.is_empty() {
...
impl<'de> serde::Deserialize<'de> for custom_tag::Environment {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.r#type.tracing.v2.CustomTag.Environment")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<custom_tag::Environment, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut name__ = None;
        ...
        deserializer.deserialize_struct("envoy.r#type.tracing.v2.CustomTag.Environment", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for custom_tag::Header {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("envoy.r#type.tracing.v2.CustomTag.Header", len)?;
        if !self.name.is_empty() {
            struct_ser.serialize_field("name", &self.name)?;
        }
        if !self.default_value.is_empty() {
...
impl<'de> serde::Deserialize<'de> for custom_tag::Header {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.r#type.tracing.v2.CustomTag.Header")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<custom_tag::Header, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut name__ = None;
        ...
        deserializer.deserialize_struct("envoy.r#type.tracing.v2.CustomTag.Header", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for custom_tag::Literal {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("envoy.r#type.tracing.v2.CustomTag.Literal", len)?;
        if !self.value.is_empty() {
...
impl<'de> serde::Deserialize<'de> for custom_tag::Literal {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.r#type.tracing.v2.CustomTag.Literal")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<custom_tag::Literal, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
        ...
        deserializer.deserialize_struct("envoy.r#type.tracing.v2.CustomTag.Literal", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for custom_tag::Metadata {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("envoy.r#type.tracing.v2.CustomTag.Metadata", len)?;
...
impl<'de> serde::Deserialize<'de> for custom_tag::Metadata {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct envoy.r#type.tracing.v2.CustomTag.Metadata")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<custom_tag::Metadata, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut kind__ = None;
        ...
        deserializer.deserialize_struct("envoy.r#type.tracing.v2.CustomTag.Metadata", FIELDS, GeneratedVisitor)
    }
}
